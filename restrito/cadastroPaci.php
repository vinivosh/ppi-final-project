  ...
  <h2>Cadastro de Paciente</h2>
    <form class="row g-2" action="processPaci.php" method="POST">
      ...
      <div class="col-md-4 form-floating">
        <input type="text" pattern="[0-9]+([\.][0-9]{1,2})?" class="form-control" placeholder="" name="peso" id="peso" required>
        <label for="peso" class="verificacao"> Peso </label>
      </div>

      <!-- Altura -->
      <div class="col-md-4 form-floating">
        <input type="text" pattern="[0-9]+([\.][0-9]{1,2})?" class="form-control" placeholder="" name="altura" id="altura" required>
        <label for="altura" class="verificacao"> Altura </label>
      </div>
