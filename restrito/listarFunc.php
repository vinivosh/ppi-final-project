    ...
    <main>
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <?php
                $sql = <<<SQL
                SELECT nome, sexo, email, telefone, cep, logradouro, cidade, estado, datacontrato, salario, especialidade, crm from TF_pessoa PES
                LEFT JOIN TF_funcionario FUNC on FUNC.codigo = PES.codigo
