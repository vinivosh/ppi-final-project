<?php
    ...
    <nav>
        ...
        <ul>
            ...
            <li><a href="http://vinivosh.atwebpages.com/trabalhoFinal/agendarConsulta.php">Agendar Consulta</a></li><br class="apenasFunc"><hr>
            ...
            <li class="apenasFunc"><a href="http://vinivosh.atwebpages.com/trabalhoFinal/logout.php">Logout</a></li>
